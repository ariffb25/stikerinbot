...
*XP:* TOTAL ${exp} (${exp - min} / ${xp}) [${math <= 0 ? `Ready for *${usedPrefix}levelup*` : `${math} XP required for levelup`}]
*Level:* ${level}
*Role:* *${role}*
*Limit:* ${limit}
...
`.trim()
    ...
    conn.sendFile(m.chat, pp, 'pp.jpg', banned ? 'This person is banned' : str, m, false, { contextInfo: { mentionedJid } })
  }
}
