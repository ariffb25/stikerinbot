...
gay = `sayang`
  ...
  let buffer = await (await fetch('https://videfikri.com/api/textmaker/gtavposter/?urlgbr=' + img + '&apa=nani')).buffer() // Masukan ApiKeymu disini..
...
handler.help = ['gtavposter (reply)']
handler.tags = ['editor']
handler.command = /^gtavposter$/i
handler.owner = false
handler.mods = false
