        ...
        switch (type) {
            ...
            case 'legendary':
              ...
              case 'string':
                ...
                } else conn.reply(m.chat, `string kamu kamu tidak cukup`.trim(), m)
                break
               case 'kayu':
                ...
                } else conn.reply(m.chat, `kayu kamu kamu tidak cukup`.trim(), m)
                break
                case 'batu':
                ...
                } else conn.reply(m.chat, `batu kamu kamu tidak cukup`.trim(), m)
                break
                 case 'besi':
                if (global.db.data.users[m.sender].besi >= count * 1) {
                    try {
                        global.db.data.users[m.sender].besi -= count * 1
                        global.db.data.users[who].besi += count * 1
                ...
                } else conn.reply(m.chat, `besi kamu kamu tidak cukup`.trim(), m)
                break
            default:
