...
gay = `sayang`
  ...
  let buffer = await (await fetch('https://lolhuman.herokuapp.com/api/editor/pencil?apikey=31caf10e4a64e86c1a92bcba&img=' + img + '&apa=nani')).buffer() // Masukan ApiKeymu disini..
