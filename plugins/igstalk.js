...
let handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  conn.sendFileLoc(m.chat, json.data.profilehd, 'eror.jpg', `*Nama:* ${json.data.fullname}\n*Bio:* ${json.data.bio}\n*Followers:* ${json.data.follower}\n*Following:* ${json.data.following}\n*Posts:* ${json.data.timeline}\n*Private:* ${json.data.private ? 'Ya' : 'Tidak'}\n*Linknya:* http://instagram.com/${json.data.username}`, m, 0, { thumbnail: await (await fetch(json.data.profilehd)).buffer() })
}
